                ...
                <div class="modal-dialog">
                    <form class="modal-content" method="post" target="_blank" action="https://rednao.us5.list-manage.com/subscribe/post?u=b9238e9ea9&amp;id=fdc8bf5485">
                        ...
                        <div class="modal-body">
                            ...
                            <div style="display: inline-block;width:29%"><label><?php echo __("First Name:") ?></label></div>
                            ...
                            <div style="display: inline-block;width:29%"><label><?php echo __("Last Name:") ?></label></div>
